/*
 * This class creates an Swim activity.  It give the activity a title, location, notes, calories burned, 
 * the minutes the workout took, and the distance traveled.
 */

public class Swim extends Activity {

	//Constructor for a swim activity
	public Swim(String t, String l, String n, int c, int m, double d, int day) {
	...
	public String toString() {
		...
		getMinutes();
		getDistance();
		String str = String.format("SWIM: %s\n"
				+ "DATE: %s\n"
				+ "LOCATION: %s\n"
				+ "NOTES: %s\n"
				+ "CALORIES: %d calories\n"
